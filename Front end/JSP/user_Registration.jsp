...
<body style="background:linear-gradient(to right, #FF8C00,  #DD6E0F);">
    ...
    <div class="container-1 d-flex justify-content-between">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="logo-text">
                <p>
                    <h3>Competitive Exam Preparation System </h3>
                </p>
            </div>
        </div>
    </div>

    <form name="form" action="RegistrationServlet" method="post" onsubmit="return validateForm()">
        <div class="container">
            <div class="brand-logo"></div>/OnlineExam
